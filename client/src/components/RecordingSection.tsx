...
export default function RecordingSection({
  ...
  const { permissionStatus, requestPermission, isDenied } =
  ...
  const handleSaveRecording = async () => {
    ...
    try {
      ...
      if (recordingBlob.size < 1000) {
        // Less than 1KB is suspiciously small
        console.warn(
      ...
      const fileExtension = Object.prototype.hasOwnProperty.call(
        fileExtensionMap,
        mimeType,
      )
      ...
      let troubleshootingMessage =
        "Please check your microphone permissions and try again with a shorter recording.";
      ...
      if (error instanceof Error) {
        ...
        if (
          ...
          errorMessage =
            "Your recording is too large or your connection is slow.";
          troubleshootingMessage =
            "Try recording a shorter segment or check your internet connection.";
        } else if (
          ...
          errorMessage =
            "The recording format is not supported or the file is corrupted.";
          troubleshootingMessage =
            "Try using a different browser or restart your device and try again.";
        } else if (
          ...
          troubleshootingMessage =
            "Check that your microphone is working and not muted, then try again.";
        } else if (
          ...
          errorMessage =
            "The app doesn't have permission to use your microphone.";
          troubleshootingMessage =
        ...
        <div className="px-4 py-5 sm:p-6">
          ...
          <div className="text-center py-6">
            ...
            <button
              ...
              title={
                hasExceededWordLimit
                  ? "Word limit exceeded. Please upgrade your subscription to continue."
                  : "Start recording"
              }
            >
            ...
            {isDenied && !isRecording && (
              <div className="mt-3 p-2 bg-red-50 text-red-600 rounded-md flex items-center text-sm">
                ...
                <span>
                  ...
                  settings to record conversations.
                </span>
              </div>
            )}
              ...
              <div className="flex items-center justify-center space-x-8">
                <div className="flex items-center space-x-2">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) =>
                      setDetectSpeakers(checked === true)
                    }
                ...
                <div className="flex items-center space-x-2">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) =>
                      setCreateTranscript(checked === true)
                    }
                    disabled={isRecording}
                  />
