    ...
    try {
      ...
      while (true) {
        try {
          ...
          console.log(
            `Network request failed, retrying (${retries}/${MAX_RETRIES})...`,
          );
      ...
      try {
        ...
        console.log(
          "Could not log response headers due to browser restrictions",
        );
      }
      ...
      if (response.ok || response.redirected) {
        ...
        try {
          ...
          if (userResponse.ok) {
            ...
            console.log(
              "Could not fetch user data, redirecting to onboarding as fallback",
            );
            window.location.href = "/onboarding";
          }
        } catch (userError) {
        ...
        <div className="space-y-6">
          <div className="bg-blue-50 border-l-4 border-blue-400 p-4">
            <p className="text-sm text-blue-700">
              Transform your leadership communication skills with personalized
              AI coaching.
            </p>
          </div>
          ...
          <div className="flex items-center space-x-2 p-3 bg-gray-50 rounded-lg">
            <Checkbox
              ...
              onCheckedChange={(checked) =>
                setForceOnboarding(checked === true)
              }
            />
            <label
